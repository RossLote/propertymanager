...
class UserTest(TestCase):
    ...
    def test_user_get_full_name(self):
        ...
        self.assertEqual(user.get_full_name(), '{} {}'.format(self.first_name, self.last_name))
...
class EmailUserAdminTest(TestCase):
    ...
    def setUp(self):
        ...
        if settings.AUTH_USER_MODEL == "user.EmailUser":
            self.app_name = "user"
...
class TestViews(TestCase):
    ...
    def test_signup_view_renders_correct_html(self):
        ...
        html = render_to_string('user/signup.html', {'form': EmailUserCreationForm()})
